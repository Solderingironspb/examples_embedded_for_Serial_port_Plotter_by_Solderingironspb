...
//#define FreeRTOS_USE //Использовать FreeRTOS
    ...
    bool CMSIS_SPI_TransmitReceive_8BIT(SPI_TypeDef* SPI, uint8_t* tx_data, uint8_t* rx_data, uint16_t Size_data, uint32_t Timeout_ms); //Функция отправки и приема по SPI
